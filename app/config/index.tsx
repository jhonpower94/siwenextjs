...
export const siweConfig = createSIWEConfig({
  ...
  verifyMessage: async ({ message, signature }: SIWEVerifyMessageArgs) => {
    try {
      ...
      console.log(
        `chainid: ${chainId} address: ${address} message: ${encodedmessage} signature: ${signature}`
      );
      ...
      addWallet(address, {
        ...
        // store.getState().sitedata.url
        const url = store.getState().sitedata.url;
